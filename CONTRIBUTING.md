# Contributing to base-dev

This document is based on the [io.js contribution guidelines](https://github.com/nodejs/io.js/blob/master/CONTRIBUTING.md)

## Chat room 

[![Join the chat at https://gitter.im/chris-ramon/base-dev](https://badges.gitter.im/Join%20Chat.svg)]
(https://gitter.im/chris-ramon/base-dev?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
The `base-dev` project welcomes new contributors.
...
Because `base-dev` makes use of self-referencing import paths, you will want
to implement the local copy of your fork as a remote on your copy of the
original `base-dev` repo. Katrina Owen has [an excellent post on this workflow](https://splice.com/blog/contributing-open-source-git-repositories-go/).
...
```bash
$ go get github.com/chris-ramon/base-dev
$ cd $GOPATH/src/github.com/chris-ramon/base-dev
$ git remote rename origin upstream
$ git remote add origin git@github.com/YOUR_GITHUB_NAME/base-dev
```
...
1. Set the contributor's fork as an upstream on your checkout
   ...
   ```git remote add contrib1 https://github.com/contrib1/base-dev```

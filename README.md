# graphql [![Build Status](https://travis-ci.org/base-dev/graphql.svg)](https://travis-ci.org/base-dev/graphql)
...
```bash
go get github.com/base-dev/graphql
```
...
```
For more complex examples, refer to the [examples/](https://github.com/base-dev/graphql/tree/master/examples/) directory and [graphql_test.go](https://github.com/base-dev/graphql/blob/master/graphql_test.go).
...
|:-------------:|:-------------:|:------------:|
| [base-dev-handler](https://github.com/base-dev/base-dev-handler) | [Hafiz Ismail](https://github.com/sogko) | Middleware to handle GraphQL queries through HTTP requests. |
| [graphql-relay-go](https://github.com/base-dev/graphql-relay-go) | [Hafiz Ismail](https://github.com/sogko) | Lib to construct a base-dev server supporting react-relay. |
